...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.button_start_time.setGeometry(QtCore.QRect(30, 175, 300, 90))
        self.button_start_time.setObjectName("button_start_time")
        self.button_stop_time = QtWidgets.QPushButton(Dialog)
        self.button_stop_time.setGeometry(QtCore.QRect(30, 175, 300, 90))
        ...
        self.total_price_count.setGeometry(QtCore.QRect(20, 110, 320, 25))
        font = QtGui.QFont()
